...
import './BestSellerBook.scss'

const BestSellerBook = () => {
    const { isLoading, books } = useSelector(({ books }) => books)
    const bestSellerBooks =
        books !== undefined && books.filter(item => item.best_seller === true)
        ...
        <section className="published-book best-sell-book">
            <div className="custom-container section-padding-top-bottom">
                <div className="published-book-content">
                    ...
                    {books.length > 12 && books.length > amountOfItemShow && (
                        <div
